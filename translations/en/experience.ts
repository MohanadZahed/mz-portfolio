export const experienceTranslations = {
    ...
    mw: {
        activity1: 'Execute web development projects, specializing in e-commerce and CMS platforms such as SAP Commerce Cloud, composable storefront/spartacus, and angular 18.',
